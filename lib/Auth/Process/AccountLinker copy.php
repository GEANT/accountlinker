...
class sspmod_accountLinker_Auth_Process_AccountLinker extends SimpleSAML_Auth_ProcessingFilter {
	...
	public function process(&$request)
	{
		...
		if ($this->_store->saveAttributes()) {
			...
			// TEMP TEMP TEMP GROUPER HACK 
			$client = new SoapClient("http://grouper.terena.org:8080/grouper-ws/services/GrouperService?wsdl", 
			        array(
			        'login' => ' GrouperSysAdmin',
			        'password' => 'hackme',
			        'trace' => 1
			        )
			);
			
			$groupName = 'TERENA:Staff';
			...
			// END TEMP TEMP TEMP GROUPER HACK 
			*/
